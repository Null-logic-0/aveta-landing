...
function HowItWorks() {
  return (
    <section
      className="flex justify-between max-lg:flex-wrap gap-6 items-center"
      id="how-it-works"
    >
      ...
      <div className="flex flex-col gap-4 ">
        ...
        <Paragraph text="This concise version provides a quick overview of the process, making it easy for users to understand how to get started with Aveta’s AI tools." />
        ...
        <Button
          ...
          className="w-[20%] max-sm:w-[50%] h-[60px]"
        >
          Start Chatting
        </Button>
      </div>
